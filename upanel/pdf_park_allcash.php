...
ob_start();
 ...
 if(isset($_REQUEST['criteria']) AND isset($_REQUEST['user']) ){
    ...
    $no =0;
    $stms_doctor = $conn->prepare(" SELECT * FROM park_out where total_paid is not null ");                     
    try {
    ...
    $this->Image('../img/logo.jpg',10,10,30);
        ...
        $this->Cell(60);
        //Title
           $this->Cell(157,7,'PARKING TODAY ALL CASH REPORT',0,0,'C');
    ...
    $pdf->SetTitle(" PARKING TODAY ALL CASH REPORT ");
    	...
    	$pdf->SetTextColor(0,0,0);	
    	$pdf->Cell(165, 1," Parking Today All Cash Lists ", 0, 1, 'R');
    ...
    $n1 = $tech_name." PARKING TODAY ALL CASH REPORT ";
    $pdf->Output($n1 . '.pdf', 'I');
    $pdf->Output();
