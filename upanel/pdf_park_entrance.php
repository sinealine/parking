...
if (isset($_REQUEST['criteria']) && isset($_REQUEST['user'])) {
    $date = date("Y-m-d H:s:i");
    $criteria = $_REQUEST['criteria'];
    $user = $_REQUEST['user'];
    $no = 0;
    $stms_doctor = $conn->prepare(" SELECT * FROM park_in WHERE " . $criteria . " ");
    try {
        ...
        if ($row_doctor > 0) {
            ...
            extends PDF_Rotate
            {
                ...
                function Header()
                {
                    ...
                    $this->Cell(60);
                    //Title
                    $this->Cell(157, 7, 'PARKING ENTRANCE REPORT', 0, 0, 'C');
            ...
            $pdf->SetTitle(" PARKING ENTRANCE REPORT ");
            ...
            $pdf->SetTextColor(0, 0, 0);
            $pdf->Cell(165, 1, " Parking Entries Lists ", 0, 1, 'R');
            ...
            $pdf->Cell(40, 7, 'Phone Number', 1);
            $pdf->Cell(40, 7, 'Entry Time', 1);
            $pdf->Cell(70, 7, 'Served By', 1);
...
$n1 = $tech_name . " PARKING ENTRANCE REPORT";
$pdf->Output($n1 . '.pdf', 'I');
$pdf->Output();
