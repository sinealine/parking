...
if (isset($_POST['btn-save'])) {
  ...
  try {
    ...
    $sql = " INSERT INTO tbl_user_access(u_names, username, password, email, phone, function, status, date) 
			        VALUES ('$u_names','$u_names',ENCODE('" . htmlspecialchars($_POST['u_password'], ENT_QUOTES) . "','itecltd'),'$u_email','$u_phone','$fnct','Active','$creat_date')";
    $conn->exec($sql);
...
if (isset($_GET['delete_id'])) {
  try {
    ...
    //for Deleting user
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $sql = " DELETE FROM tbl_user_access WHERE u_id='$delete_data' ";
    $conn->exec($sql);
    $lastId = $conn->lastInsertId();
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <?php
            $select = $conn->prepare("SELECT * FROM tbl_user_access,tbl_function WHERE tbl_user_access.function=tbl_function.fnct_id  AND tbl_user_access.function !=1");
            $select->execute();
            ...
            ?>
                        ...
                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <select
                                                        ...
                                                        <?php
                                $stmt = $db->query(" SELECT * FROM tbl_function WHERE fnct_id='$user_function' ORDER BY fnct_id ASC");
                                ...
                                ?>
                                                ...
                                                <?php if ($_SESSION['function'] == "1" || $_SESSION['function'] == "2") { ?>
                                                <td><a
                                                        href="index.php?page=updateuser&user_data=<?php echo $row_1['u_id']; ?>"><i
                                                            class="fa fa-edit"></i> Edit</a>&nbsp;&nbsp;&nbsp;
                                                    |&nbsp;&nbsp;&nbsp;<a
                                                        href="index?page=users&delete_id=<?php echo $row_1['u_id']; ?>&user_name=<?php echo $user_name; ?>"><i
...
<?php include 'SuperAdmin/users_modal.php'; ?>